...
op.add_option("--NOMOUSE", action="store_true", dest="nomouse",
              help="Hide mouse.")
op.add_option("--NOSHOWFREQ", action="store_true", dest="showfreq",
              help="Hide freq.")			  
op.add_option("--NOINFO", action="store_true", dest="info_phase",
...
op.add_option("--screenresolution", action="store", type="string", dest="screenresolution",
              help="--screenresolution.=800x600")
op.add_option("--ident", action="store", type="string", dest="ident",
              help="Main Windows Title")
op.add_option("--fontsize", action="store", type="int", dest="fontsize",
              help="fontsize >= 9")
op.add_option("--freqgridticksinterval", action="store", type="int", dest="freqgridticksinterval",
              help="Freq Ticks interval in hz.")
op.add_option("--freqlabelticksinterval", action="store", type="int", dest="freqlabelticksinterval",
              help="Ticks label interval for freq.")		  
op.add_option("--scalscreensep", action="store", type="float", dest="scalscreensep",
              help="Scalar value waterfall and spectrum separation")
